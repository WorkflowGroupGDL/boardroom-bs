...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getByUserID(userId, name, properties, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (userId === null || userId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getByUserID", "userId");
            }
            ...
            if (name !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(name, "Array<string>", "");
...
class BasicApiResponseProcessor {
    getByUserIDWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponsePublicBusinessUnitNoPaging", "");
