...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    filesV3FilesFileIdDownload(fileId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (fileId === null || fileId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "filesV3FilesFileIdDownload", "fileId");
            }
...
class BasicApiResponseProcessor {
    filesV3FilesFileIdDownloadWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
