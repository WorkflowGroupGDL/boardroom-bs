...
class ObservableGenerateApi {
    ...
    generateTokenWithHttpInfo(identificationTokenGenerationRequest, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.generateTokenWithHttpInfo(rsp)));
        }));
    }
    generateToken(identificationTokenGenerationRequest, _options) {
        return this.generateTokenWithHttpInfo(identificationTokenGenerationRequest, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
