    ...
    generateToken(identificationTokenGenerationRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (identificationTokenGenerationRequest === null || identificationTokenGenerationRequest === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "generateToken", "identificationTokenGenerationRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(identificationTokenGenerationRequest, "IdentificationTokenGenerationRequest", ""), contentType);
...
class BasicApiResponseProcessor {
    generateTokenWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "IdentificationTokenResponse", "");
