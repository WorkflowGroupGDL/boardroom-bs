...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(formId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (formId === null || formId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "formId");
            }
    ...
    getById(formId, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (formId === null || formId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "formId");
            }
            const localVarPath = '/marketing/v3/forms/{formId}'
                .replace('{' + 'formId' + '}', encodeURIComponent(String(formId)));
    ...
    marketingV3Forms(after, archived, formTypes, limit, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            ...
            if (formTypes !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(formTypes, "Array<'hubspot' | 'captured' | 'flow' | 'blog_comment' | 'all'>", "");
                for (const serializedParam of serializedParams) {
                    requestContext.appendQueryParam("formTypes", serializedParam);
                }
            }
            if (limit !== undefined) {
    ...
    marketingV3Forms_1(formDefinitionCreateRequestBase, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (formDefinitionCreateRequestBase === null || formDefinitionCreateRequestBase === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "marketingV3Forms_1", "formDefinitionCreateRequestBase");
            }
            const localVarPath = '/marketing/v3/forms';
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(formDefinitionCreateRequestBase, "FormDefinitionCreateRequestBase", ""), contentType);
    ...
    replace(formId, hubSpotFormDefinition, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (formId === null || formId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "replace", "formId");
            }
            if (hubSpotFormDefinition === null || hubSpotFormDefinition === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "replace", "hubSpotFormDefinition");
            }
            const localVarPath = '/marketing/v3/forms/{formId}'
                .replace('{' + 'formId' + '}', encodeURIComponent(String(formId)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(hubSpotFormDefinition, "HubSpotFormDefinition", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
    ...
    update(formId, hubSpotFormDefinitionPatchRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (formId === null || formId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "formId");
            }
            if (hubSpotFormDefinitionPatchRequest === null || hubSpotFormDefinitionPatchRequest === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "hubSpotFormDefinitionPatchRequest");
            }
            const localVarPath = '/marketing/v3/forms/{formId}'
                .replace('{' + 'formId' + '}', encodeURIComponent(String(formId)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(hubSpotFormDefinitionPatchRequest, "HubSpotFormDefinitionPatchRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class BasicApiResponseProcessor {
    ...
    getByIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "FormDefinitionBase", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    marketingV3FormsWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseFormDefinitionBaseForwardPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    marketingV3Forms_1WithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
