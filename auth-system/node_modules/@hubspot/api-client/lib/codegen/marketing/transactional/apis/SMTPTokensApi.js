...
exports.SMTPTokensApiResponseProcessor = exports.SMTPTokensApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SMTPTokensApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archiveToken(tokenId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("SMTPTokensApi", "archiveToken", "tokenId");
            }
    ...
    createToken(smtpApiTokenRequestEgg, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (smtpApiTokenRequestEgg === null || smtpApiTokenRequestEgg === undefined) {
                throw new baseapi_1.RequiredError("SMTPTokensApi", "createToken", "smtpApiTokenRequestEgg");
            }
    ...
    getTokenById(tokenId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("SMTPTokensApi", "getTokenById", "tokenId");
            }
            const localVarPath = '/marketing/v3/transactional/smtp-tokens/{tokenId}'
                .replace('{' + 'tokenId' + '}', encodeURIComponent(String(tokenId)));
    ...
    getTokensPage(after, campaignName, emailCampaignId, limit, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/marketing/v3/transactional/smtp-tokens';
    ...
    resetPassword(tokenId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (tokenId === null || tokenId === undefined) {
                throw new baseapi_1.RequiredError("SMTPTokensApi", "resetPassword", "tokenId");
            }
...
exports.SMTPTokensApiRequestFactory = SMTPTokensApiRequestFactory;
class SMTPTokensApiResponseProcessor {
    archiveTokenWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createTokenWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    getTokenByIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    getTokensPageWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
    ...
    resetPasswordWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SmtpApiTokenView", "");
...
exports.SMTPTokensApiResponseProcessor = SMTPTokensApiResponseProcessor;
//# sourceMappingURL=SMTPTokensApi.js.map