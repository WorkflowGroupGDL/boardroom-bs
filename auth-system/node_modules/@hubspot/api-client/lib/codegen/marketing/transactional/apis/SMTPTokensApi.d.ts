...
export declare class SMTPTokensApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getTokensPage(after?: string, campaignName?: string, emailCampaignId?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
    resetPassword(tokenId: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class SMTPTokensApiResponseProcessor {
