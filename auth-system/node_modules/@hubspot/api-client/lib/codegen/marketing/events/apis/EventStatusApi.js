...
exports.EventStatusApiResponseProcessor = exports.EventStatusApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class EventStatusApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    cancel(externalEventId, externalAccountId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("EventStatusApi", "cancel", "externalEventId");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("EventStatusApi", "cancel", "externalAccountId");
            }
    ...
    complete(externalEventId, externalAccountId, marketingEventCompleteRequestParams, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("EventStatusApi", "complete", "externalEventId");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("EventStatusApi", "complete", "externalAccountId");
            }
            if (marketingEventCompleteRequestParams === null || marketingEventCompleteRequestParams === undefined) {
                throw new baseapi_1.RequiredError("EventStatusApi", "complete", "marketingEventCompleteRequestParams");
            }
...
exports.EventStatusApiRequestFactory = EventStatusApiRequestFactory;
class EventStatusApiResponseProcessor {
    cancelWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.EventStatusApiResponseProcessor = EventStatusApiResponseProcessor;
//# sourceMappingURL=EventStatusApi.js.map