...
class ParticipantStateApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getParticipationsBreakdownByContactId(contactIdentifier, after, limit, state, _options) {
        var _a;
    ...
    getParticipationsBreakdownByExternalEventId(externalAccountId, externalEventId, after, contactIdentifier, limit, state, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
    ...
    getParticipationsBreakdownByMarketingEventId(marketingEventId, after, contactIdentifier, limit, state, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
    ...
    getParticipationsBreakdownByContactIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseWithTotalParticipationBreakdown", "");
