...
exports.EventAttendeesApiResponseProcessor = exports.EventAttendeesApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class EventAttendeesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    recordByContactEmails(externalEventId, subscriberState, batchInputMarketingEventEmailSubscriber, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactEmails", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactEmails", "subscriberState");
            }
            if (batchInputMarketingEventEmailSubscriber === null || batchInputMarketingEventEmailSubscriber === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactEmails", "batchInputMarketingEventEmailSubscriber");
            }
    ...
    recordByContactId(objectId, subscriberState, batchInputMarketingEventSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactId", "objectId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactId", "subscriberState");
            }
            if (batchInputMarketingEventSubscriber === null || batchInputMarketingEventSubscriber === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactId", "batchInputMarketingEventSubscriber");
            }
    ...
    recordByContactIds(externalEventId, subscriberState, batchInputMarketingEventSubscriber, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactIds", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactIds", "subscriberState");
            }
            if (batchInputMarketingEventSubscriber === null || batchInputMarketingEventSubscriber === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByContactIds", "batchInputMarketingEventSubscriber");
            }
    ...
    recordByEmail(objectId, subscriberState, batchInputMarketingEventEmailSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByEmail", "objectId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByEmail", "subscriberState");
            }
            if (batchInputMarketingEventEmailSubscriber === null || batchInputMarketingEventEmailSubscriber === undefined) {
                throw new baseapi_1.RequiredError("EventAttendeesApi", "recordByEmail", "batchInputMarketingEventEmailSubscriber");
            }
...
exports.EventAttendeesApiRequestFactory = EventAttendeesApiRequestFactory;
class EventAttendeesApiResponseProcessor {
...
exports.EventAttendeesApiResponseProcessor = EventAttendeesApiResponseProcessor;
//# sourceMappingURL=EventAttendeesApi.js.map