...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    eventsV3Events(after, before, eventType, id, limit, objectId, objectPropertyPropname, objectType, occurredAfter, occurredBefore, properties, propertyPropname, sort, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(id, "Array<string>", "");
            ...
            if (objectPropertyPropname !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(objectPropertyPropname, "any", "");
            ...
            if (properties !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(properties, "Array<string>", "");
                for (const serializedParam of serializedParams) {
                    requestContext.appendQueryParam("properties", serializedParam);
                }
            }
            if (propertyPropname !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(propertyPropname, "any", "");
                for (const key of Object.keys(serializedParams)) {
                    requestContext.setQueryParam(key, serializedParams[key]);
                }
            }
    ...
    eventsV3EventsEventTypes(_options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
...
class BasicApiResponseProcessor {
    eventsV3EventsWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseExternalUnifiedEvent", "");
    ...
    eventsV3EventsEventTypesWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "VisibleExternalEventTypeNames", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
