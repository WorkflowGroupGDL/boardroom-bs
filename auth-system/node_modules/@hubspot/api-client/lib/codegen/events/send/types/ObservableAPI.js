...
exports.ObservableBatchApi = exports.ObservableBasicApi = void 0;
...
class ObservableBatchApi {
    ...
    sendWithHttpInfo(batchedBehavioralEventHttpCompletionRequest, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
    ...
    send(batchedBehavioralEventHttpCompletionRequest, _options) {
        return this.sendWithHttpInfo(batchedBehavioralEventHttpCompletionRequest, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
