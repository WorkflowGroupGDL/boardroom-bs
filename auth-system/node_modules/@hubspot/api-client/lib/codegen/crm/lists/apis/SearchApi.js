...
exports.SearchApiResponseProcessor = exports.SearchApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SearchApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmV3ListsSearch(listSearchRequest, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listSearchRequest === null || listSearchRequest === undefined) {
                throw new baseapi_1.RequiredError("SearchApi", "crmV3ListsSearch", "listSearchRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(listSearchRequest, "ListSearchRequest", ""), contentType);
...
class SearchApiResponseProcessor {
    crmV3ListsSearchWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListSearchResponse", "");
