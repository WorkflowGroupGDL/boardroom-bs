...
class ObservableListsApi {
    ...
    cancelConversionWithHttpInfo(listId, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.cancelConversionWithHttpInfo(rsp)));
        }));
    }
    cancelConversion(listId, _options) {
        return this.cancelConversionWithHttpInfo(listId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getConversionDetailsWithHttpInfo(listId, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.getConversionDetailsWithHttpInfo(rsp)));
        }));
    }
    getConversionDetails(listId, _options) {
        return this.getConversionDetailsWithHttpInfo(listId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    scheduleOrUpdateConversionWithHttpInfo(listId, publicListConversionTime, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.scheduleOrUpdateConversionWithHttpInfo(rsp)));
        }));
    }
    scheduleOrUpdateConversion(listId, publicListConversionTime, _options) {
        return this.scheduleOrUpdateConversionWithHttpInfo(listId, publicListConversionTime, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
