...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(quoteId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(quoteId, _config);
    ...
    archive(quoteId, _options) {
        return this.archiveWithHttpInfo(quoteId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.getById(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(quoteId, simplePublicObjectInput, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.update(quoteId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(quoteId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(quoteId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
