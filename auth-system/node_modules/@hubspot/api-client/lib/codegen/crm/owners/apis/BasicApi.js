...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmV3Owners(after, archived, email, limit, _options) {
        var _a;
    ...
    getById(ownerId, archived, idProperty, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (ownerId === null || ownerId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "ownerId");
            }
...
class BasicApiResponseProcessor {
    crmV3OwnersWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
