    ...
    getStatus(taskId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (taskId === null || taskId === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "getStatus", "taskId");
            }
    ...
    start(publicExportRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicExportRequest === null || publicExportRequest === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "start", "publicExportRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(publicExportRequest, "PublicExportRequest", ""), contentType);
...
class AdvancedApiResponseProcessor {
    getStatusWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ActionResponseWithSingleResultURI", "");
