...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    getById(exportId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (exportId === null || exportId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "exportId");
            }
    ...
    getByIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PublicExportResponse", "");
