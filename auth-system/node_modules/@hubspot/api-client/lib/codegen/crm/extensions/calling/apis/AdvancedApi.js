...
class AdvancedApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmV3ExtensionsCallingInboundCall(completedThirdPartyCallRequest, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (completedThirdPartyCallRequest === null || completedThirdPartyCallRequest === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "crmV3ExtensionsCallingInboundCall", "completedThirdPartyCallRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(completedThirdPartyCallRequest, "CompletedThirdPartyCallRequest", ""), contentType);
    ...
    markAsReady(markRecordingAsReadyRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (markRecordingAsReadyRequest === null || markRecordingAsReadyRequest === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "markAsReady", "markRecordingAsReadyRequest");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(markRecordingAsReadyRequest, "MarkRecordingAsReadyRequest", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class AdvancedApiResponseProcessor {
    crmV3ExtensionsCallingInboundCallWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CompletedThirdPartyCallResponse", "");
    ...
    markAsReadyWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
