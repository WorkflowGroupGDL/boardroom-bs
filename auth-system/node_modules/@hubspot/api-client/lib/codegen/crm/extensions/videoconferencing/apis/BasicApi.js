...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(appId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "appId");
            }
    ...
    getById(appId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "appId");
            }
            const localVarPath = '/crm/v3/extensions/videoconferencing/settings/{appId}'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
    ...
    replace(appId, externalSettings, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "replace", "appId");
            }
            if (externalSettings === null || externalSettings === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "replace", "externalSettings");
            }
            const localVarPath = '/crm/v3/extensions/videoconferencing/settings/{appId}'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)));
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(externalSettings, "ExternalSettings", ""), contentType);
    ...
    getByIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ExternalSettings", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
