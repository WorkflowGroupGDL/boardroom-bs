...
class AdvancedApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmV3ExtensionsCardsDevAppIdViewsMigrate(appId, cardMigrateViewsRequest, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "crmV3ExtensionsCardsDevAppIdViewsMigrate", "appId");
            }
            if (cardMigrateViewsRequest === null || cardMigrateViewsRequest === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "crmV3ExtensionsCardsDevAppIdViewsMigrate", "cardMigrateViewsRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(cardMigrateViewsRequest, "CardMigrateViewsRequest", ""), contentType);
...
class AdvancedApiResponseProcessor {
    crmV3ExtensionsCardsDevAppIdViewsMigrateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CardMigrateViewsResponse", "");
