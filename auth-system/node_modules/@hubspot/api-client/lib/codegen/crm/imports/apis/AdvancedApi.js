...
class AdvancedApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmV3Imports(files, importRequest, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (importRequest !== undefined) {
                localVarFormParams.append('importRequest', importRequest);
            }
    ...
    crmV3ImportsImportIdCancel(importId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (importId === null || importId === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "crmV3ImportsImportIdCancel", "importId");
            }
...
class AdvancedApiResponseProcessor {
    ...
    crmV3ImportsImportIdCancelWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
