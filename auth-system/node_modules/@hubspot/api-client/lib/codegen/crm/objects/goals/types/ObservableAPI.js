...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(goalTargetId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(goalTargetId, _config);
    ...
    archive(goalTargetId, _options) {
        return this.archiveWithHttpInfo(goalTargetId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(goalTargetId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        const requestContextPromise = this.requestFactory.getById(goalTargetId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    updateWithHttpInfo(goalTargetId, simplePublicObjectInput, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.update(goalTargetId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(goalTargetId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(goalTargetId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
