...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(emailId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(emailId, _config);
    ...
    archive(emailId, _options) {
        return this.archiveWithHttpInfo(emailId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.getById(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(emailId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(emailId, simplePublicObjectInput, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.update(emailId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(emailId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(emailId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
