...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(taxId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(taxId, _config);
    ...
    archive(taxId, _options) {
        return this.archiveWithHttpInfo(taxId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(taxId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        const requestContextPromise = this.requestFactory.getById(taxId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(taxId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(taxId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(taxId, simplePublicObjectInput, idProperty, _options) {
        ...
        const requestContextPromise = this.requestFactory.update(taxId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(taxId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(taxId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
