...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(communicationId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(communicationId, _config);
    ...
    archive(communicationId, _options) {
        return this.archiveWithHttpInfo(communicationId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(communicationId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.getById(communicationId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(communicationId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(communicationId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(communicationId, simplePublicObjectInput, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.update(communicationId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(communicationId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(communicationId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
