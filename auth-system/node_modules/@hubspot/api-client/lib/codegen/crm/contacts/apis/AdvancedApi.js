    ...
    merge(publicMergeInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicMergeInput === null || publicMergeInput === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "merge", "publicMergeInput");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(publicMergeInput, "PublicMergeInput", ""), contentType);
    ...
    purge(publicGdprDeleteInput, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (publicGdprDeleteInput === null || publicGdprDeleteInput === undefined) {
                throw new baseapi_1.RequiredError("AdvancedApi", "purge", "publicGdprDeleteInput");
            }
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(publicGdprDeleteInput, "PublicGdprDeleteInput", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
