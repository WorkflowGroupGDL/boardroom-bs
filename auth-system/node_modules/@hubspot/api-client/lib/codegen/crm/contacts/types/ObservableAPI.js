...
class ObservableBasicApi {
    ...
    archive(contactId, _options) {
        return this.archiveWithHttpInfo(contactId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getById(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(contactId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    purgeWithHttpInfo(publicGdprDeleteInput, _options) {
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)((rsp) => this.responseProcessor.purgeWithHttpInfo(rsp)));
        }));
    }
    purge(publicGdprDeleteInput, _options) {
        return this.purgeWithHttpInfo(publicGdprDeleteInput, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    update(contactId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(contactId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
