...
class BatchApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    crmObjectSchemasV3SchemasBatchRead(objectSchemaBatchReadRequest, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectSchemaBatchReadRequest === null || objectSchemaBatchReadRequest === undefined) {
                throw new baseapi_1.RequiredError("BatchApi", "crmObjectSchemasV3SchemasBatchRead", "objectSchemaBatchReadRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(objectSchemaBatchReadRequest, "ObjectSchemaBatchReadRequest", ""), contentType);
...
class BatchApiResponseProcessor {
    crmObjectSchemasV3SchemasBatchReadWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
