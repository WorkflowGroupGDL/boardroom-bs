...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    archiveAssociation(associationIdentifier, objectType, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (associationIdentifier === null || associationIdentifier === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archiveAssociation", "associationIdentifier");
            }
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archiveAssociation", "objectType");
            }
    ...
    create(objectSchemaEgg, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectSchemaEgg === null || objectSchemaEgg === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "objectSchemaEgg");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(objectSchemaEgg, "ObjectSchemaEgg", ""), contentType);
    ...
    getAll(archived, includeAssociationDefinitions, includeAuditMetadata, includePropertyDefinitions, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/crm-object-schemas/v3/schemas';
            ...
            if (includeAssociationDefinitions !== undefined) {
                requestContext.setQueryParam("includeAssociationDefinitions", ObjectSerializer_1.ObjectSerializer.serialize(includeAssociationDefinitions, "boolean", ""));
            }
            if (includeAuditMetadata !== undefined) {
                requestContext.setQueryParam("includeAuditMetadata", ObjectSerializer_1.ObjectSerializer.serialize(includeAuditMetadata, "boolean", ""));
            }
            if (includePropertyDefinitions !== undefined) {
                requestContext.setQueryParam("includePropertyDefinitions", ObjectSerializer_1.ObjectSerializer.serialize(includePropertyDefinitions, "boolean", ""));
            }
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
    ...
    getById(objectType, includeAssociationDefinitions, includeAuditMetadata, includePropertyDefinitions, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
    ...
    update(objectType, objectTypeDefinitionPatch, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectTypeDefinitionPatch === null || objectTypeDefinitionPatch === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "objectTypeDefinitionPatch");
            }
            const localVarPath = '/crm-object-schemas/v3/schemas/{objectType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(objectTypeDefinitionPatch, "ObjectTypeDefinitionPatch", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class BasicApiResponseProcessor {
    ...
    archiveAssociationWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("204", response.httpStatusCode)) {
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
    ...
    createWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("201", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ObjectSchema", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getAllWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseObjectSchemaNoPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    updateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ObjectTypeDefinition", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
