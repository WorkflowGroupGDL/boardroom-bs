...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectType, groupName, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (groupName === null || groupName === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "groupName");
            }
    ...
    create(objectType, propertyGroupCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (propertyGroupCreate === null || propertyGroupCreate === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "propertyGroupCreate");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(propertyGroupCreate, "PropertyGroupCreate", ""), contentType);
    ...
    getAll(objectType, locale, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
    ...
    getByName(objectType, groupName, locale, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getByName", "objectType");
            }
            if (groupName === null || groupName === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getByName", "groupName");
            }
            const localVarPath = '/crm/v3/properties/{objectType}/groups/{groupName}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)));
    ...
    update(objectType, groupName, propertyGroupUpdate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (groupName === null || groupName === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "groupName");
            }
            if (propertyGroupUpdate === null || propertyGroupUpdate === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "propertyGroupUpdate");
            }
            const localVarPath = '/crm/v3/properties/{objectType}/groups/{groupName}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(propertyGroupUpdate, "PropertyGroupUpdate", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class BasicApiResponseProcessor {
    ...
    createWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("201", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PropertyGroup", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getAllWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponsePropertyGroupNoPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getByNameWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "PropertyGroup", "");
