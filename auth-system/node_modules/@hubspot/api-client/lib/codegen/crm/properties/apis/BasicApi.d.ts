...
export declare class BasicApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getAll(objectType: string, locale?: string, _options?: Configuration): Promise<RequestContext>;
    getByName(objectType: string, groupName: string, locale?: string, _options?: Configuration): Promise<RequestContext>;
