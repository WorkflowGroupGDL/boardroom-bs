...
class ObservableBasicApi {
    ...
    archiveWithHttpInfo(invoiceId, _options) {
        ...
        const requestContextPromise = this.requestFactory.archive(invoiceId, _config);
    ...
    archive(invoiceId, _options) {
        return this.archiveWithHttpInfo(invoiceId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    getByIdWithHttpInfo(invoiceId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.getById(invoiceId, properties, propertiesWithHistory, associations, archived, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(invoiceId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        return this.getByIdWithHttpInfo(invoiceId, properties, propertiesWithHistory, associations, archived, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
    ...
    updateWithHttpInfo(invoiceId, simplePublicObjectInput, idProperty, _options) {
        let _config = this.configuration;
        let allMiddleware = [...this.configuration.middleware];
        if (_options && _options.middleware) {
            const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace';
        ...
        const requestContextPromise = this.requestFactory.update(invoiceId, simplePublicObjectInput, idProperty, _config);
        let middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        for (const middleware of allMiddleware) {
            middlewarePreObservable = middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)((ctx) => middleware.pre(ctx)));
        }
    ...
    update(invoiceId, simplePublicObjectInput, idProperty, _options) {
        return this.updateWithHttpInfo(invoiceId, simplePublicObjectInput, idProperty, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
}
