...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(environment, path, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (environment === null || environment === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "environment");
            }
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "path");
            }
    ...
    download(environment, path, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (environment === null || environment === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "download", "environment");
            }
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "download", "path");
            }
            const localVarPath = '/cms/v3/source-code/{environment}/content/{path}'
                .replace('{' + 'environment' + '}', encodeURIComponent(String(environment)))
                .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
    ...
    get(environment, path, properties, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (environment === null || environment === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "get", "environment");
            }
            if (path === null || path === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "get", "path");
            }
            ...
            if (properties !== undefined) {
                requestContext.setQueryParam("properties", ObjectSerializer_1.ObjectSerializer.serialize(properties, "string", ""));
            }
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
