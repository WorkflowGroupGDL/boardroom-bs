...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    cmsAuditLogsV3(after, before, eventType, limit, objectId, objectType, sort, userId, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/cms/audit-logs/v3';
            ...
            if (eventType !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(eventType, "Array<string>", "");
            ...
            if (objectId !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(objectId, "Array<string>", "");
                for (const serializedParam of serializedParams) {
                    requestContext.appendQueryParam("objectId", serializedParam);
                }
            }
            if (objectType !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(objectType, "Array<string>", "");
                for (const serializedParam of serializedParams) {
            ...
            if (userId !== undefined) {
                const serializedParams = ObjectSerializer_1.ObjectSerializer.serialize(userId, "Array<string>", "");
                for (const serializedParam of serializedParams) {
...
class BasicApiResponseProcessor {
    cmsAuditLogsV3WithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
