...
export declare class MultiLanguageApiRequestFactory extends BaseAPIRequestFactory {
    ...
    attachToLangGroup_1(attachToLangPrimaryRequestVNext: AttachToLangPrimaryRequestVNext, _options?: Configuration): Promise<RequestContext>;
    ...
    createLangVariation_2(contentLanguageCloneRequestVNext: ContentLanguageCloneRequestVNext, _options?: Configuration): Promise<RequestContext>;
    ...
    detachFromLangGroup_3(detachFromLangGroupRequestVNext: DetachFromLangGroupRequestVNext, _options?: Configuration): Promise<RequestContext>;
    ...
    updateLangs_4(updateLanguagesRequestVNext: UpdateLanguagesRequestVNext, _options?: Configuration): Promise<RequestContext>;
}
export declare class MultiLanguageApiResponseProcessor {
    ...
    attachToLangGroup_1WithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
    createLangVariationWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Page>>;
    createLangVariation_2WithHttpInfo(response: ResponseContext): Promise<HttpInfo<Page>>;
    detachFromLangGroupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
    detachFromLangGroup_3WithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
    ...
    updateLangs_4WithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
}
