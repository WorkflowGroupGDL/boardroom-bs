...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(urlRedirectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "urlRedirectId");
            }
    ...
    cmsUrlRedirectsV3(after, archived, createdAfter, createdAt, createdBefore, limit, sort, updatedAfter, updatedAt, updatedBefore, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/cms/url-redirects/v3';
    ...
    cmsUrlRedirectsV3_1(urlMappingCreateRequestBody, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlMappingCreateRequestBody === null || urlMappingCreateRequestBody === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "cmsUrlRedirectsV3_1", "urlMappingCreateRequestBody");
            }
            const localVarPath = '/cms/url-redirects/v3';
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(urlMappingCreateRequestBody, "UrlMappingCreateRequestBody", ""), contentType);
    ...
    getById(urlRedirectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "urlRedirectId");
            }
            const localVarPath = '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    update(urlRedirectId, urlMapping, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (urlRedirectId === null || urlRedirectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "urlRedirectId");
            }
            if (urlMapping === null || urlMapping === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "urlMapping");
            }
            const localVarPath = '/cms/v3/url-redirects/{urlRedirectId}'
                .replace('{' + 'urlRedirectId' + '}', encodeURIComponent(String(urlRedirectId)));
            ...
            requestContext.setHeaderParam("Content-Type", contentType);
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(urlMapping, "UrlMapping", ""), contentType);
            requestContext.setBody(serializedBody);
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
...
class BasicApiResponseProcessor {
    ...
    cmsUrlRedirectsV3WithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseWithTotalUrlMappingForwardPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    cmsUrlRedirectsV3_1WithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("201", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "UrlMapping", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
