...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectId, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "objectId");
            }
    ...
    create(blogAuthor, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (blogAuthor === null || blogAuthor === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "blogAuthor");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(blogAuthor, "BlogAuthor", ""), contentType);
    ...
    getById(objectId, archived, property, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "objectId");
            }
            const localVarPath = '/cms/v3/blogs/authors/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
            ...
            if (property !== undefined) {
                requestContext.setQueryParam("property", ObjectSerializer_1.ObjectSerializer.serialize(property, "string", ""));
            }
            let authMethod;
            authMethod = _config.authMethods["oauth2"];
            if (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication) {
    ...
    getPage(after, archived, createdAfter, createdAt, createdBefore, limit, property, sort, updatedAfter, updatedAt, updatedBefore, _options) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            const localVarPath = '/cms/v3/blogs/authors';
    ...
    update(objectId, blogAuthor, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "objectId");
            }
            if (blogAuthor === null || blogAuthor === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "blogAuthor");
            }
            const localVarPath = '/cms/v3/blogs/authors/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
...
class BasicApiResponseProcessor {
    ...
    getPageWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "CollectionResponseWithTotalBlogAuthorForwardPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
